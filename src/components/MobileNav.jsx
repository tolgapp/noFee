...
const MobileNav = ({ mobile }) => {
  return (
    <div className="animate-jump-in animate-once animate-duration-150 animate-delay-100 animate-ease-linear md:hidden absolute bg-white h-screen top-0 left-0 w-full">
